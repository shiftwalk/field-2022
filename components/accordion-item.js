  ...
  return (
    <div className="w-full">
      <button onClick={() => updateOpenProjects()} className="w-full text-left border-b border-black flex flex-wrap px-5 md:px-6 lg:px-8 py-5 md:py-5 lg:py-7 items-center hover:bg-white focus-visible:bg-white">
        <div className="h-[3.5vw] w-[3.5vw] lg:h-[2vw] lg:w-[2vw] bg-black rounded-full mr-4 lg:mr-5 flex items-center justify-center">
        ...
        <div className="flex-1">
          <h2 className="text-2xl lg:text-[3.2vw] xl:text-[2.4vw] leading-[1.025] lg:leading-[1.025] xl:leading-[1.025] block w-[90%] mb-0 pb-0">{question}</h2>
        </div>
      </button>
